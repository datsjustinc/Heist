...
//Credit(SaintBob): https://forum.unity.com/threads/free-basic-camera-fade-in-script.509423/
 
public class CameraFade2: MonoBehaviour
{
    static private CameraFade2 instance;
    static public CameraFade2 Instance {
        get {
            if (instance == null)
                instance = GameObject.FindObjectOfType<CameraFade2>();
